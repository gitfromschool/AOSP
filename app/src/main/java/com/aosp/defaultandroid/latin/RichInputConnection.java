...
import com.aosp.defaultandroid.latin.common.UnicodeSurrogate;
import com.aosp.defaultandroid.latin.settings.SpacingAndPunctuations;
import com.aosp.defaultandroid.latin.utils.CapsModeUtils;
import com.aosp.defaultandroid.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.aosp.defaultandroid.latin.common.Constants.UnicodeSurrogate
